...
const docTemplate = `{
    ...
    "paths": {
        "/access_levels": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos del nivel de acceso",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs.CreateAccessLevelRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs.CreateActionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/validate": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "id, email, name, role",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs.CreatePermissionRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_auth.LogoutRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_auth.RefreshRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "access_token: xxx, refresh_token: yyy",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/private/roles/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Estructura de actualización del rol",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_auth.GoogleLoginRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_auth.LoginRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_auth.RegisterRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/token_types": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos del tipo de token",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs.CreateUserTokenTypeRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "structs.CreateAccessLevelRequest": {
            "type": "object",
            "required": [
                "description",
                "name"
        ...
        "structs.CreatePermissionRequest": {
            "type": "object",
            "required": [
                "action_id",
                "resource_id",
        ...
        "structs.CreateUserTokenTypeRequest": {
            "type": "object",
            "required": [
                "type"
            ],
        ...
        "structs_auth.GoogleLoginRequest": {
            "type": "object",
            "required": [
                "id_token"
            ],
