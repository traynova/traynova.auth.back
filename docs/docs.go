...
const docTemplate = `{
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_request.UpdateUserRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_request.PasswordRecoveryRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_request.PasswordResetRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs_request.RegisterRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/structs_response.RegisterResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "structs_request.PasswordRecoveryRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "structs_request.PasswordResetRequest": {
            "type": "object",
            "required": [
                "password",
                "token"
        ...
        "structs_request.RegisterRequest": {
            "type": "object",
            "required": [
                "email",
                "name",
        ...
        "structs_response.RegisterResponse": {
            "type": "object",
            "required": [
                "email",
                "name",
